...
class My_Data_Splitter():
    ...
    def train_validation_test_split(self,
        ...
        Args:
            ...
            train_size (float or int): Proportion of the dataset to include
            in the train split (0 to 1).
            val_size (float or int): Proportion of the dataset to include
            in the validation split (0 to 1).
            test_size (float or int): Proportion of the dataset to include
            in the test split (0 to 1).
...
if __name__ == "__main__":
    ...
    splitter = My_Data_Splitter(df=df,
